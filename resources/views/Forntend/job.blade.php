...
<div class="page-top page-top-job-single" style="background-image: url('{{asset('forntend/uploads/banner.jpg')}}')">
    <div class="bg"></div>
    <div class="container">
        <div class="row">
            <div class="col-md-12 job job-single">
                <div class="item d-flex justify-content-start">
                    <div class="logo">
                        <img src="{{ asset('forntend/uploads/'.$job_single->Company->logo) }}" alt="" />
                    </div>
                    <div class="text">
                        <h3>{{ $job_single->title }}, {{ $job_single->Company->company_name }}</h3>
                        <div class="detail-1 d-flex justify-content-start">
                            <div class="category">
                                {{ $job_single->JobCategory->name }}
                            </div>
                            <div class="location">
                                {{ $job_single->JobLocation->name }}
                            </div>
                        </div>
                        <div class="detail-2 d-flex justify-content-start">
                            ...
                            <div class="budget">
                                {{ $job_single->JobSalaryRange->name }}
                            </div>
                    ...
                    <div class="summary">
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td><b>Category:</b></td>
                                    <td>{{ $job_single->JobCategory->name }}</td>
                                </tr>
                                <tr>
                                    <td><b>Location:</b></td>
                                    <td>{{ $job_single->JobLocation->name }}</td>
                                </tr>
                                <tr>
                                    <td><b>Type:</b></td>
                                    <td>{{ $job_single->JobType->name }}</td>
                                </tr>
                                <tr>
                                    <td><b>Experience:</b></td>
                                    <td>{{ $job_single->JobExperience->name }}</td>
                                </tr>
                                <tr>
                                    <td><b>Gender:</b></td>
                                    <td>{{ $job_single->JobGender->name }}</td>
                                </tr>
                                <tr>
                                    <td><b>Salary Range:</b></td>
                                    <td>{{ $job_single->JobSalaryRange->name }}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
                ...
                <div class="right-item">
                    ...
                    <div class="enquery-form">
                        <form action="{{ route('job_enquery_send_email') }}" method="post">
                            @csrf
                            <input type="hidden" name="receive_email" value="{{ $job_single->Company->email }}">
