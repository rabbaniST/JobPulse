    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Request::is('admin/dashboard') ? 'active' : '' }}"><a class="nav-link"
                    href="{{ route('admin_dashboard') }}" data-bs-toggle="tooltip" data-bs-placement="right"
            ...
            <li
                ...
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-hand-point-right"></i><span>Home Page
                        Settings</span></a>
                <ul class="dropdown-menu">
                    <li class="{{ Request::is('admin/home-page') ? 'active' : '' }}"><a class="nav-link"
                            href="{{ route('home_page_setting') }}"><i class="fas fa-angle-right"></i> Home</a></li>
                    ...
                    <li class="{{ Request::is('admin/privacy-page') ? 'active' : '' }}"><a class="nav-link"
                            href="{{ route('admin_privacy_policy') }}"><i class="fas fa-angle-right"></i> Privacy
                            Policy</a></li>
            ...
            <li class="nav-item dropdown {{ Request::is('admin/job-category')||Request::is('admin/job-location/*')||Request::is('admin/job-type/*')||Request::is('admin/job-experience/*')||Request::is('admin/job-gender/*') ? 'active' : '' }}">
            ...
            <li class="{{ Request::is('admin/why-choose') ? 'active' : '' }}"><a class="nav-link"
                    href="{{ route('admin_why_choose') }}" data-bs-toggle="tooltip" data-bs-placement="right"
            ...
            <li class="{{ Request::is('admin/testimonial') ? 'active' : '' }}"><a class="nav-link"
                    ...
                    data-bs-title="Testimonial"><i class="fas fa-hand-point-right"></i> <span>Testimonial</span></a>
            </li>

            <li class="{{ Request::is('admin/blog-post') ? 'active' : '' }}"><a class="nav-link"
