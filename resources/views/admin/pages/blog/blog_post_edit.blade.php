...
@section('heading', 'Blog Post Edit')

@section('button')
<div>
    <a href="{{ route('admin_blog_post') }}" class="btn btn-primary"><i class="fas fa-plus"></i> View All</a>
</div>
@endsection
...
<div class="section-body">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin_blog_post_update',$post_single->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group mb-3">
                            <label>Existing Photo</label>
                            <div>
                                <img src="{{ asset('forntend/uploads/'.$post_single->photo) }}" alt="" class="w_150">
                            </div>
                        </div>
                        <div class="form-group mb-3">
