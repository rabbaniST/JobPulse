...
class CandidateController extends Controller
{
    ...
    {
        return view('candidate.edit-password');
    }
    ...
    // Candidate Experience Section Methods
    ...
    {
        return view('candidate.experience-create');
    }
    ...
    public function experience_edit($id)
    {
        ...
        return view('candidate.experience-edit', compact('experience_single'));
    }
    ...
    public function apply_submit(Request $request, $id)
    {
        ...
        Mail::to($company_email)->send(new VerifyMail($subject,$message));
    ...
    {
        $applied_jobs = CandidateApplication::with('Job')->where('candidate_id',Auth::guard('candidate')->user()->id)->get();
