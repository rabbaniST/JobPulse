...
class ForgetPageController extends Controller
{
    public function company_forget_password()
    {
        ...
        return view('Forntend.forget_password_company', compact('other_page_item'));
    }
    ...
    public function company_reset_password($token,$email)
    {
        ...
        return view('Forntend.reset_password_company', compact('token','email'));
    }
    ...
    public function candidate_forget_password()
    {
        ...
        $other_page_item = OtherPageItem::where('id',1)->first();
        return view('Forntend.forget_password_candidate', compact('other_page_item'));
    }
    ...
    public function candidate_reset_password($token,$email)
    {
        ...
        return view('Forntend.reset_password_candidate', compact('token','email'));
    }
