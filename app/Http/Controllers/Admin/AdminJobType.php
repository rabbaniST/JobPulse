...
class AdminJobType extends Controller
{
    public function index()
    {
        $job_types = JobType::get();
        return view('admin.pages.jobtype.job_type', compact('job_types'));
    }

    public function create()
    {
        return view('admin.pages.jobtype.job_type_create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.pages.jobtype.job_type_edit',compact('job_type_single'));
    }
